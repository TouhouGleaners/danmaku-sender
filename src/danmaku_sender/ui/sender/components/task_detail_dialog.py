...
class TaskDetailDialog(QDialog):
    ...
    def _create_detail_section(self) -> QWidget:
        ...
        task = self.task
        part_label = f"P{task.part_page} - {task.part_title}" if task.part_title else f"P{task.part_page}"
        ...
        form.addRow("分P:", QLabel(part_label))
    ...
    def _create_config_section(self) -> QWidget:
        ...
        delay_form.addRow(self._burst_cb)
